...
public class CIDate {
    ...
    public void setMois(int mois) {
        if (mois < 1 || mois > 12) {
            throw new ErreurDate("Le mois doit être compris entre 1 et 12.");
        }
        this.mois = mois;
    }
    ...
    public void setJour(int jour) {
        switch (mois) {
            ...
            case 12:
                if (jour < 1 || jour > 31) {
                    throw new ErreurDate("Le jour doit être compris entre 1 et 31.");
                }
                break;
            ...
            case 11:
                if (jour < 1 || jour > 30) {
                    throw new ErreurDate("Le jour doit être compris entre 1 et 30.");
                }
                break;
            case 2:
                ...
                break;
            default:
                throw new ErreurDate("Mois invalide.");
        }
        this.jour = jour;
    }

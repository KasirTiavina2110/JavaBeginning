...
public class TestLaboratoire2 {
    ...
    public static void main(String[] args) {
                ...
                switch (choix) {
                    case 0: // Lancer un dé
                        ...
                        if (choixDe == 1)
                            ...
                            throw new DeErreur("Choix de dé invalide");
                        break;
                    ...
                    case 4: // Quitter l'application
                        ...
                        break;
                    default:
                        throw new DeErreur("Choix invalide");
                }
        ...
        } catch (EquationErreur e) {
            System.out.println("Erreur lors de la création de l'équation : " + e.getMessage());
        }
        ...
        try {
            ...
            try {
                ...
                if (userValue != 0 && userValue != 1) {
                    throw new FlipErreur("La valeur doit être soit 0 (PILE) ou 1 (FACE).");
                }
            } catch (NumberFormatException e) {
                // Si la valeur entrée n'est pas un entier
                throw new FlipErreur("Veuillez entrer un entier valide (0 pour PILE, 1 pour FACE).");
            }
        ...
        try {
            ...
            System.out.println("Erreur lors de la création du temps : " + e.getMessage());
        }
        ...
        try {
            ...
            System.out.println("Erreur lors de la creation de la date : " + e.getMessage());
        } finally {

...
public class Temps {
    ...
    public void setHeure(int heure) {
        if (heure < 0 || heure > 24) {
            throw new Labo2Erreur("L'heure doit être comprise entre 0 et 24.");
        }
        this.heure = heure;
    }
    ...
    public void setMinute(int minute) {
        if (minute < 0 || minute >= 60) {
            throw new Labo2Erreur("La minute doit être comprise entre 0 et 59.");
        }
        this.minute = minute;
    }
    ...
    public void setSeconde(int seconde) {
        if (seconde < 0 || seconde >= 60) {
            throw new Labo2Erreur("La seconde doit être comprise entre 0 et 59.");
        }
